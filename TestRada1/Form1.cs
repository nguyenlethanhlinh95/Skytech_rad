...
namespace TestRada1
{
    public partial class Form1 : Form
    {
        ...
        private void t_Tick(object sender, EventArgs e)
        {
            ...
            g.DrawRectangle(Pens.Red, 60, 60, 5, 5);
            ...
            //draw HAND
            g.DrawLine(new Pen(Color.WhiteSmoke), new Point(cx, cy), new Point(tx, ty));
            g.DrawLine(new Pen(Color.Green), new Point(cx, cy), new Point(x, y));
